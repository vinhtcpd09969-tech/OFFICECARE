...
import { createPublicAppointment, getCustomerAppointments, cancelCustomerAppointment, getPublicAppointmentById, getCustomerMedicalRecord, getCustomerTreatmentSessions } from '../controllers/appointment.controller';
