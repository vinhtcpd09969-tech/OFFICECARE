import adminFacilityRepository from './admin/adminFacility.repository';
import adminStaffRepository from './admin/adminStaff.repository';
import adminCustomerRepository from './admin/adminCustomer.repository';
import adminFinanceRepository from './admin/adminFinance.repository';
import adminAnalyticsRepository from './admin/adminAnalytics.repository';
