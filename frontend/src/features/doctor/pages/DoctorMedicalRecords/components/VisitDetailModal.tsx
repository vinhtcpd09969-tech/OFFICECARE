...
export const VisitDetailModal: React.FC<VisitDetailModalProps> = ({ visit, linkedPlan, onClose, onJumpToPlan, isInline }) => {
  ...
  const renderContent = () => (
    <>
      ...
      {isKham ? (
        <>
          <div className="bg-zinc-50/50 dark:bg-zinc-900/30 border border-zinc-150 dark:border-zinc-800 p-4 rounded-2xl">
          ...
          <div className="bg-zinc-50/50 dark:bg-zinc-900/30 border border-zinc-150 dark:border-zinc-800 p-4 rounded-2xl">
            ...
            <p className="text-sm font-semibold text-zinc-650 dark:text-zinc-300 mt-1.5">{visit.ly_do_kham || 'Không có ghi chú.'}</p>
          </div>
          ...
          {visit.anh_dinh_kem_url && (
            <div>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="block rounded-2xl border border-zinc-150 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 overflow-hidden flex items-center justify-center"
              >
          ...
          {visit.ghi_chu && (
            <div className="text-xs text-zinc-550 dark:text-zinc-400 font-medium bg-zinc-50 dark:bg-zinc-850/40 p-3.5 rounded-xl border border-zinc-150 dark:border-zinc-800 italic">
        ...
        <div className="bg-zinc-50/50 dark:bg-zinc-900/30 border border-zinc-150 dark:border-zinc-800 p-4 rounded-2xl">
          ...
          <p className="text-sm font-semibold text-zinc-650 dark:text-zinc-300 mt-1.5">{visit.ghi_chu || 'Chưa ghi nhận.'}</p>
        </div>
      )}
      ...
      <div className="border-t border-zinc-150 dark:border-zinc-800 pt-4 flex items-center gap-3.5">
        {visit.anh_nhan_su ? (
  ...
  if (isInline) {
    return (
      <div className="bg-white dark:bg-zinc-900/40 rounded-3xl border border-zinc-150 dark:border-zinc-800 p-6 space-y-5 max-h-[650px] overflow-y-auto">
        <div className="border-b border-zinc-150 dark:border-zinc-800 pb-4 mb-4">
          <h3 className="text-base font-black text-secondary dark:text-zinc-100 leading-snug">
