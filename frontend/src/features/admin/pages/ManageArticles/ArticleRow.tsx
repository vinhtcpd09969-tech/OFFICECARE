...
export function ArticleRow({ article, onEdit, onDelete }: ArticleRowProps) {
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-12 lg:items-center gap-6 lg:gap-4">
        <div className="col-span-12 lg:col-span-6 min-w-0 flex gap-4">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-[11px] text-zinc-450 mt-1 font-medium line-clamp-1">{article.tom_tat}</p>
          </div>
        </div>
        ...
        <div className="col-span-6 lg:col-span-1 flex items-center justify-end gap-2">
          <button
            ...
            className="p-2 rounded-lg bg-slate-50 hover:bg-teal-50 text-slate-500 hover:text-teal-600 border border-zinc-150 transition-all"
            title="Sửa"
          >
            <Pencil size={13} />
          </button>
          <button
            ...
            className="p-2 rounded-lg bg-slate-50 hover:bg-rose-50 text-slate-500 hover:text-rose-600 border border-zinc-150 transition-all"
            title="Xóa"
          >
            <Trash2 size={13} />
          </button>
