                ...
                staffList.map((staff) => (
                  <tr key={staff.id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="p-4 text-center">
                      ...
                      <button className="text-red-600 hover:text-red-800 text-sm font-medium">Khóa</button>
                    </td>
                  </tr>
                ))
              )}
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-md w-full overflow-hidden">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-6">
              ...
              <div className="mt-6 flex justify-end gap-3">
                ...
                <button type="submit" className="px-4 py-2 text-white bg-teal-600 hover:bg-teal-700 rounded-lg font-medium">Tạo Tài khoản</button>
              </div>
            </form>
          </div>
        </div>
