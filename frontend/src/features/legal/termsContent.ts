...
export const TERMS_OF_SERVICE: TermsSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '4.4 Ưu đãi tự động theo hình thức thanh toán: Khi mua Gói liệu trình, hệ thống tự động áp dụng giảm giá 10% cho hình thức Trả thẳng và 5% cho hình thức Trả góp (hình thức Từng buổi không có ưu đãi tự động). Nếu Khách hàng sử dụng thêm Mã giảm giá (Voucher) cho cùng hóa đơn, ưu đãi tự động này sẽ KHÔNG được cộng dồn — hệ thống chỉ áp dụng mức giảm giá của Voucher.',
    ],
  },
  {
    heading: '5. Chính sách mã giảm giá (Voucher)',
    paragraphs: [
      '5.1 Điều kiện áp dụng: Mỗi Voucher có thể được giới hạn theo một hoặc nhiều hình thức thanh toán cụ thể (Trả thẳng/Trả góp/Từng buổi) và/hoặc giá trị đơn hàng tối thiểu. Voucher không ghi rõ giới hạn hình thức thanh toán được áp dụng cho mọi hình thức.',
      ...
      '5.3 Không cộng dồn: Voucher không được cộng dồn với ưu đãi tự động theo hình thức thanh toán (Điều 4.4) hoặc với Voucher khác trên cùng một hóa đơn.',
  ...
  },
  {
    ...
    paragraphs: [
      '6.1 Điều kiện miễn phí: Khách hàng được miễn phí 100% chi phí khám lâm sàng ban đầu khi mua Gói liệu trình (nhiều buổi) theo hình thức Trả thẳng hoặc Trả góp, với điều kiện giá trị gốc của gói (không bao gồm phí khám) đạt từ 1.000.000đ trở lên.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '8.2 Nhóm đã thanh toán trước (gói liệu trình Trả thẳng hoặc Trả góp):',
  ...
  {
    heading: '11. Tích hợp cổng thanh toán SePay & Bên thứ ba',
    paragraphs: [
      '11.1 Chuyển khoản tự động: OfficeCare sử dụng dịch vụ cổng quét mã chuyển khoản tự động của đối tác thứ ba (SePay) để xác nhận hóa đơn tức thì. Mọi thông tin chuyển khoản phải tuân thủ đúng mã QR hoặc cú pháp nội dung chuyển khoản hệ thống hiển thị.',
      '11.2 Miễn trừ trách nhiệm kỹ thuật: Trường hợp xảy ra lỗi giao dịch do hệ thống ngân hàng hoặc cổng thanh toán SePay (treo tiền, chậm kết nối API), OfficeCare có trách nhiệm phối hợp với đối tác và ngân hàng để đối soát dòng tiền cho Khách hàng trong vòng 07 ngày làm việc. OfficeCare được miễn trừ trách nhiệm bồi thường đối với các sự cố gián đoạn dịch vụ xuất phát trực tiếp từ phía ngân hàng hoặc SePay.',
    ],
  },
  {
    heading: '12. Bảo mật thông tin bệnh án & Dữ liệu cá nhân',
    paragraphs: [
      '12.1 Tiêu chuẩn bảo mật: Toàn bộ dữ liệu bệnh án điện tử, thông tin y khoa, lịch sử điều trị của Khách hàng được bảo mật nghiêm ngặt theo các tiêu chuẩn y tế hiện hành và Nghị định 13/2023/NĐ-CP về bảo vệ dữ liệu cá nhân.',
      '12.2 Phạm vi sử dụng: Dữ liệu chỉ được sử dụng cho mục đích theo dõi phác đồ điều trị nội bộ và cải tiến chất lượng y khoa. OfficeCare cam kết không chia sẻ dữ liệu bệnh án cho bất kỳ bên thứ ba nào vì mục đích thương mại khi chưa có sự đồng ý bằng văn bản của Khách hàng.',
    ],
  },
  {
    heading: '13. Miễn trừ trách nhiệm y khoa',
    paragraphs: [
  ...
  {
    heading: '14. Sở hữu trí tuệ, Luật áp dụng & Giải quyết tranh chấp',
    paragraphs: [
      '14.1 Sở hữu trí tuệ: Toàn bộ mã nguồn hệ thống đặt lịch, cấu trúc dữ liệu, nhãn hiệu, logo, các bài viết kiến thức y khoa chuẩn SEO đăng tải trên website OfficeCare đều thuộc sở hữu trí tuệ độc quyền của OfficeCare.',
      '14.2 Luật điều chỉnh: Điều khoản dịch vụ này được điều chỉnh và giải thích theo quy định của pháp luật nước Cộng hòa Xã hội Chủ nghĩa Việt Nam.',
      '14.3 Giải quyết tranh chấp: Mọi tranh chấp phát sinh trong quá trình sử dụng dịch vụ trước hết sẽ được ưu tiên giải quyết thông qua thương lượng hòa giải. Trường hợp không đạt được đồng thuận, tranh chấp sẽ được đưa ra giải quyết tại Tòa án nhân dân có thẩm quyền tại Thành phố Hồ Chí Minh.',
    ],
  },
];
