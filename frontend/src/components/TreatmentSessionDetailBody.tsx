...
// vas_sau), chỉ khác chan_doan/chong_chi_dinh luôn null ở dịch vụ lẻ nên tự ẩn — không cần fallback
// text "Đang chờ cập nhật..." như bản cũ (sai bản chất: dịch vụ lẻ vốn dĩ không có 2 field này).
